...
def main():
    ...
    #Add image of water
    image = Image.open("/Users/apple/Desktop/CGU/SEM 2/CS Insights Via Python/Project/Water quality image.jpg")
    st.image(image, use_column_width=True)

    #Add description of the app
    st.write('This app predicts the potability of water based on various factors')
